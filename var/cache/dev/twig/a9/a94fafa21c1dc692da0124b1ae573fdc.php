...
class __TwigTemplate_c51be2c60739645e9f76c2cc822e9b54 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"row\">
  <div class=\"col-md-5\">
    <img
      src=\"/uploads/";
        // line 7
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 7, $this->source); })()), "illustration", [], "any", false, false, false, 7), "html", null, true);
        echo "\"
      alt=\"";
        // line 8
  ...
  <div class=\"col-md-7 my-auto\">
    ...
    <a
      href=\"";
        // line 22
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("add_to_cart", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 22, $this->source); })()), "id", [], "any", false, false, false, 22)]), "html", null, true);
        echo "\"
...
";
    ...
    {
        return array (  174 => 35,  157 => 33,  140 => 32,  127 => 22,  121 => 19,  114 => 15,  109 => 13,  105 => 12,  98 => 8,  94 => 7,  88 => 3,  78 => 2,  36 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("{% extends 'base.html.twig' %} {% block title %}{{ product.name }} - Poke Bio {%
endblock %} {% block content %}

<div class=\"row\">
  <div class=\"col-md-5\">
    <img
      src=\"/uploads/{{ product.illustration }}\"
      alt=\"{{ product.name }}\"
      class=\"img-fluid\" />
  </div>
  <div class=\"col-md-7 my-auto\">
