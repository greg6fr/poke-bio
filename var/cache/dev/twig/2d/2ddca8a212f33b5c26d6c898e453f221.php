...
class __TwigTemplate_af33959ae06408e4bb495c822ef5745f extends Template
{
    private $source;
    private $macros = [];
...
(isset($context["attribute"]) || array_key_exists("attribute", $context) ? $context["attribute"] : (function () { throw new RuntimeError('Variable "attribute" does not exist.', 323, $this->source); })()), "type", [], "any", false, false, false, 323) == "string")) {
                ...
                echo "                        </td>
                        <td>";
                // line 332
                echo $this->extensions['Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension']->dumpData($this->env, twig_get_attribute($this->env, $this->source, $context["decision"], "seek", ["object"], "method", false, false, false, 332));
                echo "</td>
                    </tr>
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "C:\\la-boutique-francaise\\vendor\\symfony\\security-bundle\\Resources\\views\\Collector\\security.html.twig");
    }
}
